...
exports.default = {
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        ...
                        case 8:
                            page = _context.sent;
                            _context.next = 11;
                            return _this.abortPageRequest(page, ['image', 'document'], function (theUrl, originAbort) {
    ...
    abortPageRequest: function abortPageRequest(page) {
        var _this6 = this;

        var resources = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : ['image', 'stylesheet', 'document'];
                    ...
                    switch (_context6.prev = _context6.next) {
                        ...
                        case 2:
                            ...
                            page.on('request', function (request) {
                                ...
                                if (_lodash2.default.indexOf(resources, resourceType) >= 0) {
                                    abort = true;
                                }
                                if (filter) {
